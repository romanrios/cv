document.getElementById("en").onclick = function () {
    ...
    document.getElementById("foot_text").placeholder = "<br>This website was created as a final project for Ticmas Academy's Front-end Web Development course.";
...
document.getElementById("es").onclick = function () {
    ...
    document.getElementById("foot_text").placeholder = "<br>Este sitio web fue creado como proyecto final para el curso de Desarrollo Web Front-end de Ticmas Academy.";
}
