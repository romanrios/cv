...
document.getElementById("en").onclick = function () {
    ...
    document.getElementById("exp_codoacodo-react").innerHTML = '■ React JS specialization course <span class="anio">~ In progress</span>';
...
document.getElementById("es").onclick = function () {
    ...
    document.getElementById("exp_codoacodo-react").innerHTML = '■ Curso de especialización React JS <span class="anio">~ En curso</span>';
