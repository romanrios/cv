...
document.getElementById("en").onclick = function () {
    /*hero*/
    document.getElementById("hhero").innerHTML = "Visual Communication Design<br><em>> Web Development and Video games</em>"
    /*navbar y títulos*/
    ...
    document.getElementById("exp_tecnicatura").innerHTML = "Higher Technician Degree in Software Development";
    document.getElementById("anio_tecnicatura").innerHTML = "2024 ~ In progress";
    document.getElementById("anio_codoacodo").innerHTML = "2024 ~ In progress";
    ...
    document.getElementById("anio_universidad").innerHTML = "2005 ~ Pending thesis";
    document.getElementById("exp_argentina").innerHTML = "■ #SeProgramar course (INTI)<br>■ Front-end Development (Ticmas)<br>■ Android App Development (Ticmas)<br>■ Front-end Development (Educado en Argentina)<br>■ English Level 8 B1.2 MCER (CUI-UBA)";
    ...
    document.getElementById("exp_codoacodo-react").innerHTML = "■ React JS specialization course";
...
document.getElementById("es").onclick = function () {
    /*hero*/
    document.getElementById("hhero").innerHTML = "Diseño de Comunicación Visual<br><em>> Desarrollo Web y Videojuegos</em>";
    /*navbar y títulos*/
    ...
    document.getElementById("exp_tecnicatura").innerHTML = "Tecnicatura Superior en Desarrollo de Software";
    document.getElementById("anio_tecnicatura").innerHTML = "2024 ~ En curso";
    document.getElementById("anio_codoacodo").innerHTML = "2024 ~ En curso";
    ...
    document.getElementById("anio_universidad").innerHTML = "2005 ~ Tesina pendiente";
    document.getElementById("exp_argentina").innerHTML = "■ Curso #SeProgramar (INTI)<br>■ Desarrollo Front-end (Ticmas)<br>■ Desarrollo de aplicaciones Android (Ticmas)<br>■ Desarrollo Front-end (Educado en Argentina)<br>■ Inglés Nivel 8 B1.2 MCER (CUI-UBA)";
    ...
    document.getElementById("exp_codoacodo-react").innerHTML = "■ Curso de especialización React JS";
