const elements_innerHTML = {
    hero_subtitle: {
        en: "Software Developer /<br/>Visual Communication Designer",
...
const translatePage = (lang) => {
    ...
    document.querySelectorAll(".project-header").forEach((header) => {
        header.innerHTML = header.innerHTML
            ...
            .replace(/Desarrollo|Development/g, lang === "en" ? "Development" : "Desarrollo")
...
const navItems = ["nav_inicio", "nav_experiencia", "nav_habilidades", "nav_proyectos", "nav_contacto", "nav_downloads"];
